...
```
## 4. Download Snapshot.
The Snapshot will take about 10GB. The latest shanpshot you can found [here](https://community.optimism.io/docs/developers/build/run-a-node/#get-the-data-dir)
```
mkdir temp
cd temp
...
👉[Optimism Official docs](https://community.optimism.io/docs/developers/build/run-a-node/)
...
👉[Optimism Bedrock Goerli Snapshot](https://datadirs.optimism.io/goerli-bedrock.tar.zst) 
